  ...
  const recipes = [
    ...
    { // Осмиевый нож
      ...
      key: {
        ...
        B: 'delightful:knightmetal_knife',
        C: 'silentgear:blazing_dust'
      },
      id: `${prefix}osmium_knife`
    },
    { // Алмазный нож
    ...
    { // Аметистовый нож
      ...
      key: {
        A: 'amethyst_upgrade:glow_amethyst', 
        B: 'delightful:enderite_knife',
        C: 'silentgear:glittery_dust'
      },
      id: `${prefix}large_amethyst_knife`
    },
    { // Нож из чёрного опала
      ...
      key: {
        A: 'silentcompat:voidmetal_ingot', 
        B: 'delightful:large_amethyst_knife',
        C: 'silentgear:glittery_dust'
      },
      id: `${prefix}black_opal_knife`
    },
