ServerEvents.recipes(e => {
    ...
    const recipes = [
        {
            ingredients: ['#tm4:petal_blocks', 'botania:manasteel_ingot', 'botania:mana_powder', 'forbidden_arcanus:arcane_bone_meal', 'forbidden_arcanus:arcane_bone_meal', 'botania:rune_earth'],
