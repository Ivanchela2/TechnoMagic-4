ServerEvents.recipes(e => {
    ...
    },
    {
        ...
        duration: 3600,
        ritual_dummy: {item: "occultism:ritual_dummy/custom_ritual"},
        ingredients: [{tag: 'botania:dreamwood_logs'},{tag: 'botania:dreamwood_logs'},{tag: 'botania:dreamwood_logs'},{tag: 'botania:dreamwood_logs'},{tag: 'botania:dreamwood_logs'},{tag: 'botania:dreamwood_logs'}, {item: 'botania:elementium_block'}, {tag: 'tm4:petal_blocks'}, {item: 'botania:terrasteel_ingot'}, {tag: 'tm4:petal_blocks'}],
