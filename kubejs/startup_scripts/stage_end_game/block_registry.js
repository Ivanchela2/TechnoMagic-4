StartupEvents.registry('block', event => {
    const blocks = [
        ...
        { render: 'solid', id: 'gribtweaks:infinity_heavy_cogwheel', alias: '§dInfinity Heavy Cogwheel', material: 'metal', hardness: 20, light: 0.6, tag: 'extendedgears:cogwheel', tag: 'extendedgears:metal_cogwheel', tag: 'extendedgears:small_cogwheel' },
