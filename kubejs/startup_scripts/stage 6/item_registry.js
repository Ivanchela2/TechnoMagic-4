StartupEvents.registry('item', event => {
    ...
    event.create('gribtweaks:photoniy').displayName('§1Фотон'); 
    event.create('gribtweaks:photoniy_ingot').displayName('§1Фотонный слиток'); 
    event.create('gribtweaks:spectral_circuit').displayName('Спектральная электросхема'); 
    event.create('gribtweaks:photoniy_circuit').displayName('§1Фотонная электросхема'); 
